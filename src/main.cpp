...
uint256 hashGenesisBlock("0xa2bc1b407f7d3db6fb8269ce1fd46803eb39445f828ab038681c546eaa855974");
...
const string strMessageMagic = "blacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // blacoin: 1 days
static const int64 nTargetSpacing = 120; // blacoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal blacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "blacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfc8cd2d73cc6f5832e69294689db7d2983f197e7699dbc57d25dc9add9dffad5");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "blacoin test";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510470844; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3171027;

        if (fTestNet)
        {
            block.nTime    = 1510380544;
            block.nNonce   = 1396306;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5d79771ab44a31886190ba4b545a12ef2129387da2f2ff5de6121fa35ca6794f"));
